...
[AWS Serverless Application Model (SAM) CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,732 | 🐛 533 | 🌐 Python | 📅 2026-09-11 is a command line tool for an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. With just a few lines of configuration, you can define the application you want and model it.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 56 | 🌐 Shell | 📅 2026-09-14 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,953 | 🐛 83 | 🌐 Go | 📅 2026-09-12 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,731 | 🐛 200 | 🌐 Jinja | 📅 2026-09-14, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,731 | 🐛 200 | 🌐 Jinja | 📅 2026-09-14, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,731 | 🐛 200 | 🌐 Jinja | 📅 2026-09-14, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,731 | 🐛 200 | 🌐 Jinja | 📅 2026-09-14, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,731 | 🐛 200 | 🌐 Jinja | 📅 2026-09-14 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal
...
[Restify](https://github.com/restify/node-restify) ⭐ 10,688 | 🐛 132 | 🌐 JavaScript | 📅 2026-09-04 is a framework, utilizing [connect](https://github.com/senchalabs/connect) ⭐ 9,873 | 🐛 14 | 🌐 JavaScript | 📅 2024-09-27 style middleware for building REST APIs.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,509 | 🐛 338 | 🌐 Python | 📅 2024-12-17 is a command-line HTTP client. Its goal is to make CLI interaction with web services as human-friendly as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Checkov](https://www.checkov.io/) is a static code analysis tool for infrastructure as code (IaC) and also a software composition analysis (SCA) tool for images and open source packages. It scans cloud infrastructure provisioned using [Terraform](https://terraform.io/), [Terraform plan](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Terraform%20Plan%20Scanning.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Cloudformation](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Cloudformation.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [AWS SAM](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/AWS%20SAM.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Kubernetes](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Kubernetes.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Helm charts](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Helm.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Kustomize](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Kustomize.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Dockerfile](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Dockerfile.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Serverless](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Serverless%20Framework.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [Bicep](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Bicep.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10, [OpenAPI](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/OpenAPI.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10 or [ARM Templates](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Azure%20ARM%20templates.md) ⭐ 9,000 | 🐛 167 | 🌐 Python | 📅 2026-09-10 and detects security and compliance misconfigurations using graph-based scanning.

[OWASP Nettacker](https://github.com/OWASP/Nettacker) ⭐ 5,567 | 🐛 230 | 🌐 Python | 📅 2026-09-13 is a project created to automate information gathering, vulnerability scanning and eventually generating a report for networks, including services, bugs, vulnerabilities, misconfigurations, and other information. This software will utilize TCP SYN, ACK, ICMP, and many other protocols in order to detect and bypass Firewall/IDS/IPS devices.
...
[Sliver](https://github.com/BishopFox/sliver) ⭐ 11,825 | 🐛 231 | 🌐 Go | 📅 2026-09-13 is an open source cross-platform adversary emulation/red team framework, it can be used by organizations of all sizes to perform security testing. Sliver's implants support C2 over Mutual TLS (mTLS), WireGuard, HTTP(S), and DNS and are dynamically compiled with per-binary asymmetric encryption keys.
...
[Bandit](https://github.com/PyCQA/bandit) ⭐ 8,259 | 🐛 259 | 🌐 Python | 📅 2026-08-29 is a tool designed to find common security issues in Python code.

[Payloads All The Things](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,843 | 🐛 36 | 🌐 Python | 📅 2026-08-27 is a list of useful payloads and bypass for Web Application Security and Pentest/CTF.
...
[EarlyOOM](https://github.com/rfjakob/earlyoom) ⭐ 4,287 | 🐛 35 | 🌐 C | 📅 2026-08-20 is a daemon for Linux that enables users to more quickly recover and regain control over their system in low-memory situations with heavy swap usage.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,322 | 🐛 628 | 🌐 Go | 📅 2026-09-11 is an unsupervised, coverage-guided kernel fuzzer.
...
[Node.js Build Working Group](https://github.com/nodejs/build) ⭐ 541 | 🐛 160 | 🌐 Jinja | 📅 2026-09-10 maintains and controls infrastructure used for continuous integration (CI), releases, benchmarks, web hosting (of nodejs.org and other Node.js web properties) and more.
...
[The Node.js best practices list ](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,614 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
...
[node-gyp](https://github.com/nodejs/node-gyp) ⭐ 10,695 | 🐛 171 | 🌐 Python | 📅 2026-09-10 is a cross-platform command-line tool written in Node.js for compiling native addon modules for Node.js. It contains a vendored copy of the gyp-next project that was previously used by the Chromium team, extended to support the development of Node.js native addons.

[nvm ](https://github.com/nvm-sh/nvm) ⭐ 95,079 | 🐛 389 | 🌐 Shell | 📅 2026-09-11 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,896 | 🐛 221 | 🌐 JavaScript | 📅 2026-09-14 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.

[AVA](https://github.com/avajs/ava) ⭐ 20,826 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-17 is a test runner for Node.js with a concise API, detailed error output, embrace of new language features and process isolation that lets you develop with confidence.
...
[axios](https://github.com/axios/axios) ⭐ 109,214 | 🐛 90 | 🌐 JavaScript | 📅 2026-09-13 is a promise based HTTP client for the browser and node.js.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,460 | 🐛 1,138 | 🌐 CMake | 📅 2026-09-11 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Act](https://github.com/nektos/act) ⭐ 71,995 | 🐛 380 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.

[Fiber](https://gofiber.io/) is an [Express](https://github.com/expressjs/express) ⭐ 69,454 | 🐛 227 | 🌐 JavaScript | 📅 2026-09-14 inspired web framework built on top of [Fasthttp](https://github.com/valyala/fasthttp) ⭐ 23,468 | 🐛 90 | 🌐 Go | 📅 2026-09-14, the fastest HTTP engine for Go. Designed to ease things up for fast development with zero memory allocation and performance in mind.
...
[ts-migrate](https://github.com/airbnb/ts-migrate) ⭐ 5,617 | 🐛 56 | 🌐 TypeScript | 📅 2026-01-22 is a tool for helping migrate code to TypeScript. It takes a JavaScript, or a partial TypeScript, project in and gives a compiling TypeScript project out. ts-migrate is intended to accelerate the TypeScript migration process. The resulting code will pass the build, but a followup is required to improve type safety.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,439 | 🐛 702 | 🌐 TypeScript | 📅 2026-09-14 is a repository for high quality TypeScript type definitions.

[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,652 | 🐛 646 | 🌐 TypeScript | 📅 2026-09-11 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,623 | 🐛 567 | 🌐 WebAssembly | 📅 2026-09-14.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,691 | 🐛 1,512 | 🌐 TypeScript | 📅 2026-09-14 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.

[InversifyJS](https://github.com/inversify/InversifyJS) ⭐ 12,067 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-19 is a powerful and lightweight inversion of control(IoC) container for JavaScript & Node.js apps powered by TypeScript. An IoC container uses a class constructor to identify and inject its dependencies.
...
[TS node](https://github.com/TypeStrong/ts-node) ⭐ 13,124 | 🐛 232 | 🌐 TypeScript | 📅 2024-07-18 is a TypeScript execution and REPL for node.js.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,268 | 🐛 7,852 | 🌐 C# | 📅 2026-09-14 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,319 | 🐛 3,895 | 🌐 C# | 📅 2026-09-14 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[rbenv](https://github.com/rbenv/rbenv) ⭐ 16,732 | 🐛 17 | 🌐 Shell | 📅 2026-07-14 allows to pick a Ruby version for your application and guarantee that your development environment matches production. Put rbenv to work with Bundler for painless Ruby upgrades and bulletproof deployments.
...
[Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,996 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 is a framework for building automated deployment scripts. Although Capistrano itself is written in Ruby, it can easily be used to deploy projects of any language or framework, be it Rails, Java, or PHP.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,778 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-14, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,944 | 🐛 105 | 🌐 Rust | 📅 2026-09-14 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 329 | 🐛 77 | 🌐 C | 📅 2026-09-13 and supports [explainshell](https://explainshell.com/) integration.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,149 | 🐛 441 | 🌐 Rust | 📅 2026-09-13 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,840 | 🐛 1,812 | 🌐 Rust | 📅 2026-09-10 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,140 | 🐛 35 | 🌐 Rust | 📅 2026-08-30 is a small set of exercises to get you used to reading and writing Rust code.
