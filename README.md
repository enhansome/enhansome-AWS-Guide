...
[AWS Serverless Application Model (SAM) CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,732 | 🐛 534 | 🌐 Python | 📅 2026-09-10 is a command line tool for an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. With just a few lines of configuration, you can define the application you want and model it.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,939 | 🐛 84 | 🌐 Go | 📅 2026-09-10 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,723 | 🐛 201 | 🌐 Jinja | 📅 2026-09-11, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,723 | 🐛 201 | 🌐 Jinja | 📅 2026-09-11, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,723 | 🐛 201 | 🌐 Jinja | 📅 2026-09-11, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,723 | 🐛 201 | 🌐 Jinja | 📅 2026-09-11, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,723 | 🐛 201 | 🌐 Jinja | 📅 2026-09-11 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal
...
[Checkov](https://www.checkov.io/) is a static code analysis tool for infrastructure as code (IaC) and also a software composition analysis (SCA) tool for images and open source packages. It scans cloud infrastructure provisioned using [Terraform](https://terraform.io/), [Terraform plan](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Terraform%20Plan%20Scanning.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Cloudformation](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Cloudformation.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [AWS SAM](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/AWS%20SAM.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Kubernetes](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Kubernetes.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Helm charts](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Helm.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Kustomize](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Kustomize.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Dockerfile](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Dockerfile.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Serverless](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Serverless%20Framework.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [Bicep](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Bicep.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10, [OpenAPI](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/OpenAPI.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10 or [ARM Templates](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Azure%20ARM%20templates.md) ⭐ 8,995 | 🐛 168 | 🌐 Python | 📅 2026-09-10 and detects security and compliance misconfigurations using graph-based scanning.

[OWASP Nettacker](https://github.com/OWASP/Nettacker) ⭐ 5,561 | 🐛 223 | 🌐 Python | 📅 2026-09-09 is a project created to automate information gathering, vulnerability scanning and eventually generating a report for networks, including services, bugs, vulnerabilities, misconfigurations, and other information. This software will utilize TCP SYN, ACK, ICMP, and many other protocols in order to detect and bypass Firewall/IDS/IPS devices.
...
[Sliver](https://github.com/BishopFox/sliver) ⭐ 11,815 | 🐛 230 | 🌐 Go | 📅 2026-09-10 is an open source cross-platform adversary emulation/red team framework, it can be used by organizations of all sizes to perform security testing. Sliver's implants support C2 over Mutual TLS (mTLS), WireGuard, HTTP(S), and DNS and are dynamically compiled with per-binary asymmetric encryption keys.
...
[Bandit](https://github.com/PyCQA/bandit) ⭐ 8,258 | 🐛 259 | 🌐 Python | 📅 2026-08-29 is a tool designed to find common security issues in Python code.

[Payloads All The Things](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 80,790 | 🐛 36 | 🌐 Python | 📅 2026-08-27 is a list of useful payloads and bypass for Web Application Security and Pentest/CTF.
...
[Scrummage](https://github.com/matamorphosis/Scrummage) ⭐ 540 | 🐛 1 | 🌐 Python | 📅 2025-01-02 is an OSINT tool that centralises search functionality from a bounty of powerful, publicly-available, third-party, [OSINT](https://osintframework.com/) websites.
...
[EarlyOOM](https://github.com/rfjakob/earlyoom) ⭐ 4,277 | 🐛 35 | 🌐 C | 📅 2026-08-20 is a daemon for Linux that enables users to more quickly recover and regain control over their system in low-memory situations with heavy swap usage.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,320 | 🐛 628 | 🌐 Go | 📅 2026-09-10 is an unsupervised, coverage-guided kernel fuzzer.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,314 | 🐛 700 | 🌐 Python | 📅 2026-09-10 for high performance training and inference.
...
[Node.js Build Working Group](https://github.com/nodejs/build) ⭐ 541 | 🐛 157 | 🌐 Jinja | 📅 2026-09-10 maintains and controls infrastructure used for continuous integration (CI), releases, benchmarks, web hosting (of nodejs.org and other Node.js web properties) and more.
...
[The Node.js best practices list ](https://github.com/goldbergyoni/nodebestpractices) ⭐ 105,609 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15
...
[node-gyp](https://github.com/nodejs/node-gyp) ⭐ 10,692 | 🐛 171 | 🌐 Python | 📅 2026-09-10 is a cross-platform command-line tool written in Node.js for compiling native addon modules for Node.js. It contains a vendored copy of the gyp-next project that was previously used by the Chromium team, extended to support the development of Node.js native addons.

[nvm ](https://github.com/nvm-sh/nvm) ⭐ 95,065 | 🐛 384 | 🌐 Shell | 📅 2026-09-11 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,897 | 🐛 239 | 🌐 JavaScript | 📅 2026-09-10 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.

[AVA](https://github.com/avajs/ava) ⭐ 20,825 | 🐛 74 | 🌐 JavaScript | 📅 2026-06-17 is a test runner for Node.js with a concise API, detailed error output, embrace of new language features and process isolation that lets you develop with confidence.

[egg](https://eggjs.org/) is a born to build better enterprise frameworks and apps with Node.js & Koa.

[mysqljs](https://github.com/mysqljs/mysql) ⭐ 18,620 | 🐛 175 | 🌐 JavaScript | 📅 2024-06-25 is a pure node.js JavaScript Client implementing the MySQL protocol.

[axios](https://github.com/axios/axios) ⭐ 109,224 | 🐛 93 | 🌐 JavaScript | 📅 2026-09-10 is a promise based HTTP client for the browser and node.js.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,459 | 🐛 1,114 | 🌐 CMake | 📅 2026-09-11 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,686 | 🐛 130 | 🌐 Java | 📅 2026-08-31 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,811 | 🐛 916 | 🌐 Go | 📅 2026-09-10 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 57,950 | 🐛 2,455 | 🌐 Go | 📅 2026-09-11 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[zap](https://github.com/uber-go/zap) ⭐ 24,652 | 🐛 192 | 🌐 Go | 📅 2026-08-31 is a blazing fast, structured, leveled logging in Go.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,431 | 🐛 690 | 🌐 TypeScript | 📅 2026-09-10 is a repository for high quality TypeScript type definitions.

[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,654 | 🐛 639 | 🌐 TypeScript | 📅 2026-09-11 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,622 | 🐛 568 | 🌐 WebAssembly | 📅 2026-09-10.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,680 | 🐛 1,506 | 🌐 TypeScript | 📅 2026-09-11 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.

[InversifyJS](https://github.com/inversify/InversifyJS) ⭐ 12,070 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-19 is a powerful and lightweight inversion of control(IoC) container for JavaScript & Node.js apps powered by TypeScript. An IoC container uses a class constructor to identify and inject its dependencies.
...
[TS node](https://github.com/TypeStrong/ts-node) ⭐ 13,126 | 🐛 232 | 🌐 TypeScript | 📅 2024-07-18 is a TypeScript execution and REPL for node.js.
...
[.NET runtime](https://github.com/dotnet/runtime) ⭐ 18,265 | 🐛 7,786 | 🌐 C# | 📅 2026-09-11 is a collection of libraries and shared host (dotnet) installers for all supported platforms, as well as the sources to .NET runtime and libraries.
...
[Polly](https://github.com/App-vNext/Polly) ⭐ 14,237 | 🐛 3 | 🌐 C# | 📅 2026-09-09 is a .NET resilience and transient-fault-handling library that allows developers to express policies such as Retry, Circuit Breaker, Timeout, Bulkhead Isolation, and Fallback in a fluent and thread-safe manner.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,049 | 🐛 171 | 🌐 C# | 📅 2026-09-10 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,323 | 🐛 3,930 | 🌐 C# | 📅 2026-09-11 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Airbnb's Ruby Style Guide](https://github.com/airbnb/ruby) ⭐ 3,893 | 🐛 17 | 🌐 Ruby | 📅 2025-12-19
...
[Capistrano](https://github.com/capistrano/capistrano) ⭐ 12,995 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 is a framework for building automated deployment scripts. Although Capistrano itself is written in Ruby, it can easily be used to deploy projects of any language or framework, be it Rails, Java, or PHP.
...
[React-Rails](https://github.com/reactjs/react-rails) ⭐ 6,773 | 🐛 38 | 🌐 JavaScript | 📅 2026-07-31 is a flexible tool to use [React](http://facebook.github.io/react/) with Rails. By integrating React.js with Rails views and controllers, the asset pipeline, or webpacker.
...
[Scientist](https://github.com/github/scientist) ⭐ 7,754 | 🐛 16 | 🌐 Ruby | 📅 2026-09-10 is a Ruby library for carefully refactoring critical paths.
...
[Guzzle](https://github.com/guzzle/guzzle) ⭐ 23,456 | 🐛 1 | 🌐 PHP | 📅 2026-09-06 is a PHP HTTP client that makes it easy to send HTTP requests and trivial to integrate with web services.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,776 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-11, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 26,914 | 🐛 102 | 🌐 Rust | 📅 2026-09-11 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 329 | 🐛 76 | 🌐 C | 📅 2025-12-02 and supports [explainshell](https://explainshell.com/) integration.
...
[Cargo](https://github.com/rust-lang/cargo) ⭐ 15,463 | 🐛 1,671 | 🌐 Rust | 📅 2026-09-08 is a package manager that downloads your Rust project’s dependencies and compiles your project.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,118 | 🐛 435 | 🌐 Rust | 📅 2026-09-11 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.
...
[Servo](https://github.com/servo/servo) ⭐ 37,954 | 🐛 3,191 | 🌐 Rust | 📅 2026-09-11 is a prototype web browser engine written in the Rust language.
