...
[AWS Serverless Application Model (SAM) CLI](https://github.com/aws/aws-sam-cli) ⭐ 6,733 | 🐛 539 | 🌐 Python | 📅 2026-09-24 is a command line tool for an open-source framework for building serverless applications. It provides shorthand syntax to express functions, APIs, databases, and event source mappings. With just a few lines of configuration, you can define the application you want and model it.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 41 | 🌐 Shell | 📅 2026-09-25 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.
...
[K3s](https://github.com/rancher/k3s) ⭐ 34,034 | 🐛 106 | 🌐 Go | 📅 2026-09-24 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[Kubespray](https://kubespray.io/) is a tool that combines Kubernetes and Ansible to easily install Kubernetes clusters that can be deployed on [AWS](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/aws.md) ⭐ 18,752 | 🐛 205 | 🌐 Jinja | 📅 2026-09-25, GCE, [Azure](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/azure.md) ⭐ 18,752 | 🐛 205 | 🌐 Jinja | 📅 2026-09-25, [OpenStack](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/openstack.md) ⭐ 18,752 | 🐛 205 | 🌐 Jinja | 📅 2026-09-25, [vSphere](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/vsphere.md) ⭐ 18,752 | 🐛 205 | 🌐 Jinja | 📅 2026-09-25, [Packet](https://github.com/kubernetes-sigs/kubespray/blob/master/docs/packet.md) ⭐ 18,752 | 🐛 205 | 🌐 Jinja | 📅 2026-09-25 (bare metal), Oracle Cloud Infrastructure (Experimental), or Baremetal
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,581 | 🐛 337 | 🌐 Python | 📅 2024-12-17 is a command-line HTTP client. Its goal is to make CLI interaction with web services as human-friendly as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Checkov](https://www.checkov.io/) is a static code analysis tool for infrastructure as code (IaC) and also a software composition analysis (SCA) tool for images and open source packages. It scans cloud infrastructure provisioned using [Terraform](https://terraform.io/), [Terraform plan](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Terraform%20Plan%20Scanning.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Cloudformation](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Cloudformation.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [AWS SAM](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/AWS%20SAM.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Kubernetes](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Kubernetes.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Helm charts](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Helm.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Kustomize](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Kustomize.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Dockerfile](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Dockerfile.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Serverless](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Serverless%20Framework.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [Bicep](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Bicep.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24, [OpenAPI](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/OpenAPI.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24 or [ARM Templates](https://github.com/bridgecrewio/checkov/blob/master/docs/7.Scan%20Examples/Azure%20ARM%20templates.md) ⭐ 9,028 | 🐛 180 | 🌐 Python | 📅 2026-09-24 and detects security and compliance misconfigurations using graph-based scanning.

[OWASP Nettacker](https://github.com/OWASP/Nettacker) ⭐ 5,616 | 🐛 250 | 🌐 Python | 📅 2026-09-22 is a project created to automate information gathering, vulnerability scanning and eventually generating a report for networks, including services, bugs, vulnerabilities, misconfigurations, and other information. This software will utilize TCP SYN, ACK, ICMP, and many other protocols in order to detect and bypass Firewall/IDS/IPS devices.
...
[Sliver](https://github.com/BishopFox/sliver) ⭐ 11,888 | 🐛 227 | 🌐 Go | 📅 2026-09-21 is an open source cross-platform adversary emulation/red team framework, it can be used by organizations of all sizes to perform security testing. Sliver's implants support C2 over Mutual TLS (mTLS), WireGuard, HTTP(S), and DNS and are dynamically compiled with per-binary asymmetric encryption keys.
...
[Bandit](https://github.com/PyCQA/bandit) ⭐ 8,282 | 🐛 258 | 🌐 Python | 📅 2026-09-21 is a tool designed to find common security issues in Python code.

[Payloads All The Things](https://github.com/swisskyrepo/PayloadsAllTheThings) ⭐ 81,187 | 🐛 36 | 🌐 Python | 📅 2026-08-27 is a list of useful payloads and bypass for Web Application Security and Pentest/CTF.
...
[Node.js Build Working Group](https://github.com/nodejs/build) ⭐ 541 | 🐛 161 | 🌐 Jinja | 📅 2026-09-24 maintains and controls infrastructure used for continuous integration (CI), releases, benchmarks, web hosting (of nodejs.org and other Node.js web properties) and more.
...
[node-gyp](https://github.com/nodejs/node-gyp) ⭐ 10,701 | 🐛 175 | 🌐 Python | 📅 2026-09-21 is a cross-platform command-line tool written in Node.js for compiling native addon modules for Node.js. It contains a vendored copy of the gyp-next project that was previously used by the Chromium team, extended to support the development of Node.js native addons.

[nvm ](https://github.com/nvm-sh/nvm) ⭐ 95,174 | 🐛 391 | 🌐 Shell | 📅 2026-09-21 is a version manager for node.js, designed to be installed per-user, and invoked per-shell. nvm works on any POSIX-compliant shell (sh, dash, ksh, zsh, bash), in particular on these platforms: unix, macOS, and windows WSL.

[node-docker](https://hub.docker.com/_/node/) is the official Node.js docker image, made with love by the node community.

[Mocha](https://github.com/mochajs/mocha) ⭐ 22,898 | 🐛 241 | 🌐 JavaScript | 📅 2026-09-23 is a simple, flexible, fun JavaScript test framework for Node.js & The Browser.
...
[mysqljs](https://github.com/mysqljs/mysql) ⭐ 18,620 | 🐛 176 | 🌐 JavaScript | 📅 2024-06-25 is a pure node.js JavaScript Client implementing the MySQL protocol.

[axios](https://github.com/axios/axios) ⭐ 109,216 | 🐛 96 | 🌐 JavaScript | 📅 2026-09-24 is a promise based HTTP client for the browser and node.js.
...
[Java Design Patterns ](https://github.com/iluwatar/java-design-patterns) ⭐ 94,727 | 🐛 128 | 🌐 Java | 📅 2026-09-13 is a collection of the best formalized practices a programmer can use to solve common problems when designing an application or system.
...
[Traefik](https://github.com/traefik/traefik) ⭐ 64,959 | 🐛 932 | 🌐 Go | 📅 2026-09-25 is a modern HTTP reverse proxy and load balancer that makes deploying microservices easy. Traefik integrates with your existing infrastructure components (Docker, Swarm mode, Kubernetes, Marathon, Consul, Etcd, Rancher, Amazon ECS, etc.) and configures itself automatically and dynamically. Pointing Traefik at your orchestrator should be the only configuration step you need.

[Gitea](https://github.com/go-gitea/gitea) ⭐ 58,156 | 🐛 2,460 | 🌐 Go | 📅 2026-09-25 is Git with a cup of tea, painless self-hosted git service. Using Go, this can be done with an independent binary distribution across all platforms which Go supports, including Linux, macOS, and Windows on x86, amd64, ARM and PowerPC architectures.
...
[Act](https://github.com/nektos/act) ⭐ 72,111 | 🐛 384 | 🌐 Go | 📅 2026-08-09 is a GO program that allows you to run our GitHub Actions locally.
...
[ts-migrate](https://github.com/airbnb/ts-migrate) ⭐ 5,622 | 🐛 57 | 🌐 TypeScript | 📅 2026-01-22 is a tool for helping migrate code to TypeScript. It takes a JavaScript, or a partial TypeScript, project in and gives a compiling TypeScript project out. ts-migrate is intended to accelerate the TypeScript migration process. The resulting code will pass the build, but a followup is required to improve type safety.
...
[Definitely Typed](https://github.com/DefinitelyTyped/DefinitelyTyped) ⭐ 51,440 | 🐛 701 | 🌐 TypeScript | 📅 2026-09-24 is a repository for high quality TypeScript type definitions.

[TypeORM](https://github.com/typeorm/typeorm) ⭐ 36,658 | 🐛 671 | 🌐 TypeScript | 📅 2026-09-21 is an ORM that can run in NodeJS, Browser, Cordova, PhoneGap, Ionic, React Native, NativeScript, Expo, and Electron platforms and can be used with TypeScript and JavaScript (ES5, ES6, ES7, ES8).
...
[AssemblyScript](https://assemblyscript.org/) compiles a strict variant of TypeScript to [WebAssembly](http://webassembly.org/) using [Binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,638 | 🐛 562 | 🌐 WebAssembly | 📅 2026-09-25.
...
[Eclipse Theia](https://github.com/eclipse-theia/theia) ⭐ 21,700 | 🐛 1,512 | 🌐 TypeScript | 📅 2026-09-25 is an extensible platform to develop full-fledged multi-language Cloud & Desktop IDE-like products with state-of-the-art web technologies.
...
[ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,135 | 🐛 178 | 🌐 C# | 📅 2026-09-25 is the open-source .NET assembly browser and decompiler.
...
[MAUI](https://github.com/dotnet/maui) ⭐ 23,320 | 🐛 4,053 | 🌐 C# | 📅 2026-09-25 is the .NET Multi-platform App UI, a framework for building native device applications spanning mobile, tablet, and desktop.
...
[Capistrano](https://github.com/capistrano/capistrano) ⭐ 13,003 | 🐛 74 | 🌐 Ruby | 📅 2026-07-19 is a framework for building automated deployment scripts. Although Capistrano itself is written in Ruby, it can easily be used to deploy projects of any language or framework, be it Rails, Java, or PHP.
...
[Scientist](https://github.com/github/scientist) ⭐ 7,758 | 🐛 16 | 🌐 Ruby | 📅 2026-09-25 is a Ruby library for carefully refactoring critical paths.
...
[VS Code Bash IDE](https://marketplace.visualstudio.com/items?itemName=mads-hartmann.bash-ide-vscode) is a Visual Studio Code extension utilizing the [bash language server](https://github.com/bash-lsp/bash-language-server/blob/master/bash-lsp) ⭐ 2,782 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-24, that is based on [Tree Sitter](https://github.com/tree-sitter/tree-sitter) ⭐ 27,043 | 🐛 109 | 🌐 Rust | 📅 2026-09-25 and its [grammar for Bash](https://github.com/tree-sitter/tree-sitter-bash) ⭐ 330 | 🐛 82 | 🌐 C | 📅 2026-09-13 and supports [explainshell](https://explainshell.com/) integration.
...
[Tokio](https://github.com/tokio-rs/tokio) ⭐ 33,231 | 🐛 448 | 🌐 Rust | 📅 2026-09-24 is an event-driven, non-blocking I/O platform for writing asynchronous applications with the Rust programming language.

[TiKV](https://github.com/tikv/tikv) ⭐ 16,873 | 🐛 1,827 | 🌐 Rust | 📅 2026-09-23 is an open-source distributed transactional key-value database that also provides classical key-vlue APIs, but also transactional APIs with ACID compliance.
...
[Servo](https://github.com/servo/servo) ⭐ 38,035 | 🐛 3,227 | 🌐 Rust | 📅 2026-09-25 is a prototype web browser engine written in the Rust language.
...
[Rustlings](https://github.com/rust-lang/rustlings) ⭐ 64,213 | 🐛 38 | 🌐 Rust | 📅 2026-09-21 is a small set of exercises to get you used to reading and writing Rust code.
